...
public class B_Main {
	public static void main(String[] args) {
		...
		/** 1. showcase access to static field and method vs instance field and method */
...
//		A_Account.printAccountInfo(); // error - instance methods require objects
		...
		/** 2. Create account objects and explain output of 'printAccountInfo' */
		...
		/** 3. Explain convention when accessing static entities */
		/*
